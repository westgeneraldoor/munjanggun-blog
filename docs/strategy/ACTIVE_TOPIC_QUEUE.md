...
| Q-063 | attack     | draft_ready      | idea              | none           | not_started        | 작은방 붙박이장과 방문 열림·문선 간섭      | 작은방붙박이장         | 2930          | 브릿지 검사 BLOCK 없음. 2026-08-24 부모 검색량 2,930이며 140번과 고객 질문이 다르다.                                 | outputs/reports/topic_candidates/2026-09-01_topic_scorecard.md               | 붙박이장 시공을 서비스처럼 쓰지 않고 작은방 여닫이 방문의 회전선·문선 마감 순서만 원고화한다.                                        | 2026-09-02 | 140번 드레스룸 슬라이딩도어와 가구 동선 표현이 근접. 부모 검색량을 결합 질문 수요로 과장 금지   | 2026-09-01 |
| Q-064 | attack     | draft_ready      | idea              | none           | not_started        | 새 방문 주문 전 손잡이·잠금·열림 방향 결정  | 도어손잡이           | 2800          | 제품 검사 BLOCK 없음. 119·150·174의 고장 후 수리와 달리 새 방문 주문 전 사용 조건을 다룬다.                               | outputs/reports/topic_candidates/2026-09-01_topic_scorecard.md               | 손잡이를 주인공이나 단독 판매 서비스로 만들지 않고 방문 주문 기준 안의 한 변수로 작성한다.                                         | 2026-09-03 | 하드웨어 클러스터 landed 1·faded 3 WARN. 152번 셀프 실측 글과 주문 시점을 분리  | 2026-09-01 |
| Q-065 | attack     | draft_ready      | idea              | none           | not_started        | 침대 배치와 방문 열림 방향 충돌         | 침대              | 89900         | 브릿지 검사 BLOCK 없음. 2026-08-24 부모 검색량 89,900이며 136·140번과 문 종류·고객 질문이 다르다.                       | outputs/reports/topic_candidates/2026-09-01_topic_scorecard.md               | 침대 판매·배치 컨설팅으로 확장하지 않고 여닫이 방문의 회전선과 열림 방향만 작성한다.                                             | 2026-09-04 | 140번의 침대·동선 표현과 근접. 부모 검색량을 결합 질문 수요로 과장 금지               | 2026-09-01 |
| Q-066 | experiment | draft_ready      | idea              | none           | not_started        | 방문 한 짝 교체 시 색과 표면 질감 차이    | 방문색상            | 400           | 제품 검사 BLOCK 없음. 164·175번과 근접해 실제 한 짝 교체 현장 근거가 있을 때만 분리 가능하다.                                | outputs/reports/topic_candidates/2026-09-01_topic_scorecard.md               | AppSheet 실제 전후 사례를 확보한 뒤 조명·노후도·표면 질감 차이에 한정해 작성한다.                                          | 2026-09-05 | 164·175번과 카니발 위험. 현장 근거 없으면 작성 보류                         | 2026-09-01 |
| Q-067 | experiment | draft_ready      | idea              | none           | not_started        | 닫힌 방문 틈으로 보이는 빛의 위치별 원인    | 문틈빛             | 미확인           | 제품 검사 BLOCK 없음. 149번 욕실 슬라이딩도어 틈과 150번 방문 닫힘 고장을 피한 증상형 후보다.                                 | outputs/reports/topic_candidates/2026-09-01_topic_scorecard.md               | 경첩·문틀 뒤틀림·바닥 간격을 구분하고 방음·냄새 차단 성능을 보장하지 않는다.                                                 | 2026-09-06 | 광고 검색량 미확인. 149·150번과 원인·문 종류 분리 필수                       | 2026-09-01 |
| Q-068 | experiment | draft_ready      | idea              | none           | not_started        | 아이방 방문의 잠금 방식과 열림 방향       | 아이방문            | 미확인           | 제품 검사 BLOCK 없음. 133번 중문 손 끼임과 달리 실내 방문 주문 단계의 사생활·비상 접근을 다룬다.                                | outputs/reports/topic_candidates/2026-09-01_topic_scorecard.md               | 잠금 사양과 가구 간섭을 실제 취급 범위에서 확인하고 안전 효과를 보장하지 않는다.                                               | 2026-09-07 | 검색량 미확인. 209번 일반 주문 글과 연속 발행 금지                           | 2026-09-01 |
| Q-069 | experiment | scorecard_needed | idea              | none           | not_started        | 로봇청소기가 방문 문턱에 걸리는 집의 제거 판단 | 로봇청소기           | 미확인           | 브릿지 검사 BLOCK 없음. 171번과 서비스는 겹치지만 로봇청소기 통과 높이라는 고객 질문은 새롭다.                                   | outputs/reports/topic_candidates/2026-09-01_topic_scorecard.md               | 2026-09-01 점수표를 다시 확인하고, 171번 보호 성과와 208~210 초기 반응을 본 뒤 작성 여부를 결정한다. 바닥 마감 확인 전 철거를 권하지 않는다. | 2026-09-09 | 방문턱제거는 바닥 공사가 따를 수 있다. 문장군 단독 서비스처럼 쓰지 않으며 171번 보호 링크가 필수 | 2026-09-01 |
...
6. 208~214는 2026-09-01 점수표로 선정했다. Q-063~Q-065를 먼저 작성하고, Q-066~Q-068은 근거 조건을 충족한 날에만 작성하며, Q-069는 관찰 뒤 결정한다.
