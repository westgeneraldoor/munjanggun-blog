...
3. 완성 원고는 `posts/NNN_키워드.md` 규칙으로 저장합니다.
4. 발행 후 URL은 `docs/strategy/POSTING_REGISTRY.md`에 등록합니다.
5. 순위 추적 결과는 `data/processed/tracking_history.json`에 누적됩니다.
6. 생성 리포트와 대시보드는 `outputs/` 아래에 저장됩니다.
