...
| Gate | Status | Notes |
| --- | --- | --- |
| Draft completed | pass | `posts/106_중문플루트유리.md` is a single publish MD with title candidates at the top |
| Post QA | pass | `node scripts/validate_post.js --from=106` passed for this post |
