...
| 소재 선정 구조 재검증 | `outputs/reports/topic_analysis/2026-09-01_rewrite_cohort_final_verdict.md` + `docs/strategy/REWRITE_COHORT_PREREGISTRATION_20260818.md` + `outputs/reports/topic_analysis/2026-08-18_preregistered_w5_verdict.md` | 180~191 최종 2/12로 사전 등록상 보류. 성공·실패를 사후 확정하지 않고 다음 코호트로 확장 판단 |
...
| 순위 변화 참고 | `outputs/reports/pair_ranking_measurement_2026-09-01_delayed.md`, `outputs/reports/pair_ranking_measurement_2026-08-24.md`, `outputs/reports/ranking_account_matches.md`, `outputs/reports/ranking_report.md`, `outputs/reports/ranking_changes_summary.md` | 8월 31일 예정분을 9월 1일 지연 측정. URL 기반 weekly/experimental 보조 |
...
| daily | `outputs/reports/daily/2026-09-01_seo_watch.md` | 2026-08-31 확정 | 1,313조회·순방문자 1,001·방문 횟수 1,039·평균 사용 시간 2m 48s. 8월 24~31일 TOP20 160행 전수 백필, 199·201~207 URL·발행일 등록 완료. |
...
| 리라이팅 코호트 최종 판정 | `outputs/reports/topic_analysis/2026-09-01_rewrite_cohort_final_verdict.md` | 180~191, 2026-08-31 확정 데이터 | D3~D14 직접 집계 2/12. 사전 등록 기준에 따라 보류·다음 코호트 확장 판정 |
...
| topic scorecard | `outputs/reports/topic_candidates/2026-09-01_topic_scorecard.md` | 2026-08-31 확정 통계, 2026-09-01 지연 순위, 2026-08-24 광고 원본 | 208~214번: 브릿지 3편·제품/현장 4편의 중복 회피, 조건부 근거, 발행 순서 |
...
| rewrite pair rank measurement | `outputs/reports/pair_ranking_measurement_2026-08-24.md` | 2026-08-24 17:41 KST | 같은 86개 조합·65개 검색어의 2차 계측. 12개 원본·새 글 쌍 17개 행 |
| rewrite pair rank measurement | `outputs/reports/pair_ranking_measurement_2026-09-01_delayed.md` | 2026-09-01 15:15 KST | 8월 31일 예정 3차를 지연 실행. 같은 86개 조합·65개 검색어, 오류 0개 |
| account URL evidence | `outputs/reports/ranking_account_matches.md` | 2026-09-01 15:15 KST | 65개 검색어에서 검출된 문장군 계정 URL 108행 |
| ranking | `outputs/reports/ranking_report.md` | 2026-09-01 | URL 기반 순위 참고 |
| ranking summary | `outputs/reports/ranking_changes_summary.md` | 2026-08-24 -> 2026-09-01 | 순위 변화 보조 |
...
| 보고서 | 기준일 | 핵심 메모 |
| --- | --- | --- |
| `outputs/reports/daily/2026-09-01_seo_watch.md` | 2026-08-31 | 조회수 1,313·순방문자 1,001·방문 횟수 1,039·평균 사용 시간 2분 48초. TOP20 20행, 207번은 부분일 관측으로 성과 미판정. |
| `outputs/reports/daily/2026-08-31_seo_watch.md` | 2026-08-30 | 조회수 1,175·순방문자 877·방문 횟수 912·평균 사용 시간 2분 15초. TOP20 20행, 205번 발행일 8위·18회. |
| `outputs/reports/daily/2026-08-30_seo_watch.md` | 2026-08-29 | 조회수 1,108·순방문자 846·방문 횟수 882·평균 사용 시간 2분 28초. TOP20 20행. |
| `outputs/reports/daily/2026-08-29_seo_watch.md` | 2026-08-28 | 조회수 1,087·순방문자 843·방문 횟수 874·평균 사용 시간 3분 2초. TOP20 20행. |
| `outputs/reports/daily/2026-08-28_seo_watch.md` | 2026-08-27 | 조회수 1,158·순방문자 881·방문 횟수 905·평균 사용 시간 3분 22초. TOP20 20행. |
| `outputs/reports/daily/2026-08-27_seo_watch.md` | 2026-08-26 | 조회수 1,263·순방문자 948·방문 횟수 985·평균 사용 시간 2분 48초. TOP20 20행. |
| `outputs/reports/daily/2026-08-26_seo_watch.md` | 2026-08-25 | 조회수 1,178·순방문자 915·방문 횟수 958·평균 사용 시간 2분 27초. TOP20 20행. |
| `outputs/reports/daily/2026-08-25_seo_watch.md` | 2026-08-24 | 조회수 1,319·순방문자 986·방문 횟수 1,024·평균 사용 시간 3분 8초. TOP20 20행. |
