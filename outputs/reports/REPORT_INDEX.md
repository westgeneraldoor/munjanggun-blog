...
| daily | `outputs/reports/daily/2026-08-18_seo_watch.md` | 2026-08-17 확정, 2026-08-18 08:53 실시간 | 1,212조회, 통합검색 81.39%. TOP20 20행, 187 URL·발행일 등록; 방문 횟수·평균 사용 시간 및 8월 14~16 daily는 백필 대기 |
...
| 보고서 | 기준일 | 핵심 메모 |
| --- | --- | --- |
| `outputs/reports/daily/2026-08-18_seo_watch.md` | 2026-08-17 | 조회수 1,212·통합검색 81.39%. TOP20 20행, 187 URL·발행일을 공개 모바일 블로그에서 직접 대조해 등록. |
